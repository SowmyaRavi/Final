...
class MentorList: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
                ...
                FIRDatabase.database().reference().child("user").queryOrdered(byChild: "level").queryEqual(toValue: "Mentor").observe(.childAdded, with: { snapshot in
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        label = label1.text!
        performSegue(withIdentifier: "mentor", sender: self)
